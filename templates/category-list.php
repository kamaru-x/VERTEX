...
<html lang="en" class="light">
    ...
    <div class="content">
              ...
              <h2 class="intro-y text-lg font-medium mt-10" style="text-align: center;font-size: 35px;color:#1e40af;padding-top: 30px;padding-bottom: 30px;border-bottom: solid 1px #bcbcbc;">Product Categories</h2>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            ...
            <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
                ...
                <a href="category-add.php"><button class="btn btn-primary shadow-md mr-2">Add New Category</button></a>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                        <tr class="intro-x">
                            ...
                            <td>
                             <div class="whitespace-nowrap">43</div>
                            </td>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40">
                                <a href="" class=" whitespace-nowrap">7</a>
                            </td>
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">Reference 7</a>
                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <a href="" class="whitespace-nowrap">8</a>
                            </td>
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">Reference 8</a>
                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <a href="" class="whitespace-nowrap">9</a>
                            </td>
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">Reference 9</a>
