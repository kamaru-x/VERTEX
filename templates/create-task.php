            ...
            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                   <label>Select Lead</label>
                        <div class="mt-2">
                            <select data-placeholder="Select Category" class="tom-select w-full">
                                <option>ABC International(REF:44667)</option>
                                <option>XYZ International(REF:89877)</option>
                                <option>ABC International(REF:44667)</option>
                                <option>XYZ International(REF:89877)</option>
                            </select>
                        </div>
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                    ...
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Task Title">
                </div>
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                   <label>Select Priority</label>
                        <div class="mt-2">
                            <select data-placeholder="Select Priority" class="tom-select w-full">
                 ...
                 <div class="col-span-12 sm:col-span-6">
                        ...
                        <input id="pos-form-3" type="file" class="form-control flex-1" placeholder="Attach File">
                </div>
                ...
                <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                    ...
                    <button class="btn btn-primary w-40 ml-2">Create Task</button>
                </div>
            </div>
        </div>
    </div>
