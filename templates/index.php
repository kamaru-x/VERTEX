                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            <div class="intro-y flex items-center h-10">
                                ...
                                <a href="" class="ml-auto flex items-center text-danger"> <i data-lucide="alert-triangle" class="w-4 h-4 mr-3"></i> You have 3 meetings today </a>
                                    ...
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto">
                                                    <div class="report-box__indicator bg-success tooltip cursor-pointer mr-3" title="60% Success" style="float: left;"> 200 <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                                    <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="40% Failed" style="float: left;"> 171 <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-medium leading-8 mt-6">471</div>
                                    ...
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto">
                                                    <div class="report-box__indicator bg-success tooltip cursor-pointer mr-3" title="87% Success" style="float: left;"> 100 <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                                    <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="13% Failed" style="float: left;"> 21 <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-medium leading-8 mt-6">121</div>
                                    ...
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto">
                                                    <div class="report-box__indicator bg-success tooltip cursor-pointer mr-3" title="70% Success" style="float: left;"> 85 <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                                    <div class="report-box__indicator bg-warning tooltip cursor-pointer mr-3" title="20% Pending" style="float: left;"> 15 <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                    <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="10% Failed" style="float: left;"> 10 <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-medium leading-8 mt-6">110</div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-medium leading-8 mt-6">102</div>
