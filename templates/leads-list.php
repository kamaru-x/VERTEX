    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            ...
            <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
                ...
                <a href="leads-add.php"><button class="btn btn-primary shadow-md mr-2">Add New Lead</button></a>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-60">
                                <a href="" class="font-medium whitespace-nowrap">ABCD International</a>
                            ...
                            <td class="w-60">
                                <a href="" class="font-medium whitespace-nowrap">Vijesh Chandran</a>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-60">
                                <a href="" class="font-medium whitespace-nowrap">XYZ International</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">4433 6688 / info@abcdintl.com</div>
