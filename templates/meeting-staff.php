...
<html lang="en" class="light">
    ...
    <div class="content">
              ...
              <h2 class="intro-y text-lg font-medium mt-10" style="text-align: center;font-size: 35px;color:#1e40af;padding-top: 30px;padding-bottom: 30px;border-bottom: solid 1px #bcbcbc;">Staff Wise Meeting</h2>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap" style="text-align:center;">PREVIOUS MEETINGS </th>
                         <th class="text-center whitespace-nowrap">UPCOMING MEETINGS</th>
                       <!--  <th class="whitespace-nowrap">
                ...
                <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-60 ref">
                                <div class="text-warning">Meeting 1</div>
                                 
                            </td>
                            <td class="w-60 ref">
                                <div class="text-success">Meeting 2</div>
                            ...
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a class="flex items-center text-primary whitespace-nowrap mr-5" href="meeting-staff-view.php">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-60 ref">
                                <div class="text-warning">Meeting 4</div>
                                 
                            </td>
                            <td class="w-60 ref">
                                <div class="text-success">Meeting 5</div>
                        ...
                        <tr class="intro-x">
                           ...
                           <td class="w-60 ref">
                                <div class="text-warning">Meeting 6</div>
                                 
                            </td>
                            <td class="w-60 ref">
                                <div class="text-success">Meeting 7</div>
                        ...
                        <tr class="intro-x">
                           ...
                           <td class="w-60 ref">
                                <div class="text-warning">Meeting 8</div>
                                 
                            </td>
                            <td class="w-60 ref">
                                <div class="text-success">Meeting 9</div>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-60 ref">
                                <div class="text-warning">Meeting 10</div>
                                 
                            </td>
                            <td class="w-60 ref">
                                <div class="text-success">Meeting 11</div>
