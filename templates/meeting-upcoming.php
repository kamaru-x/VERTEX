                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                     <tr>
                                                        ...
                                                        <td>Telephone</td>
                                                        <td class="text-primary">10:00 AM - 12.00PM</td>
                                                        <!-- <td>Add updates by monday</td>
                                                         <td> <a class="flex items-center text-primary whitespace-nowrap mr-5" href="meeting-upcoming-details.php" title="view">
