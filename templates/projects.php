            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap" style="text-align: center;">MOBILE NUMBER </th>
                        <!-- <th class="text-center whitespace-nowrap" style="text-align: left;">Proposal Date</th> -->
                        <th class="whitespace-nowrap" style="text-align: right;">
                            <div class="pr-16">SALESMAN NAME & ID</div>
                        </th>
                        <th class="whitespace-nowrap">
                ...
                <tbody>
                            ...
                            <td class="w-72">
                                <a href="view-leads.php" class="font-medium whitespace-nowrap">ABCD International</a>
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap text-primary">
                                 ...
                                 <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">info@abcdintl.com</div>
                            </td>
                            
                            <td style="text-align:center;">
                              <div class="whitespace-nowrap">John Davis</div>
                            ...
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center text-primary whitespace-nowrap mr-5" href="javascript:;">
                                        <i data-lucide="eye" class="w-4 h-4 mr-1"></i> View Project
                                    </a>
