...
<html lang="en" class="light">
    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        ...
        <br><br><hr>
        <h2 class="intro-y text-lg font-medium mt-10" style="text-align: center;font-size: 35px;color:#1e40af;padding-top: 30px;padding-bottom: 30px;border-bottom: solid 1px #bcbcbc21;">Proposal</h2>
            ...
            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div class="intro-y col-span-12 sm:col-span-12">
                   <label>Select Product</label>
                        <div class="mt-2">
                            <select data-placeholder="Select Product" class="tom-select w-full">
                ...
                <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                    ...
                    <button class="btn btn-primary w-24 ml-2" style="width: 12rem;">Add Product</button>
                </div>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a class="flex items-center text-danger whitespace-nowrap" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal">
                                        <i data-lucide="trash" class="w-4 h-4 mr-1"></i> Remove
                                    </a><!--  <a class="flex items-center text-primary whitespace-nowrap" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal">
                    ...
                    <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                            ...
                            <div class="mt-5">
                                    ...
                                    margin-right: auto;display: block;margin-top: 10px; width:90px;" data-tw-toggle="modal" data-tw-target="#new-order-modal2"><button class="btn btn-primary shadow-md mr-2">Save</button>
                                    </div>
                                <div>
                                </div>
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                     ...
                     <div class="col-span-12">
                       ...
                       <textarea id="update-profile-form-5" class="form-control" placeholder="Message"></textarea>
                    </div>
                </div>
                <div class="modal-footer text-right">
                    <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-32 mr-1">Cancel</button>
                    <button type="button" class="btn btn-primary w-32">Save</button>
                </div>
            </div>
        </div>
    </div>
