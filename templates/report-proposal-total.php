            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">DATE OF PROPOSAL</th>
                        <th class="text-center whitespace-nowrap" style="
    text-align: left;">SALESMAN</th>
                        <th class="whitespace-nowrap" style="
    text-align: center;">VALUE OF PROPOSAL</th>
                        <th class="whitespace-nowrap">
                            <div class="pr-16">DATE OF REJECTION / APPROVAL</div>
                        </th>
                ...
                <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-72 text-primary">
                               <a href="" class="font-medium whitespace-nowrap">Roy Thomas</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">5500 3488</div>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">roythomas@gmail.com</div>
                            </td>
                            <td class="w-60">
                                <a href="" class="font-medium whitespace-nowrap">23/3/2023</a>
                            ...
                            <td class="w-60 text-right text-danger">
                                <div class="pr-16">$200,000</div>
                            </td>
                            <td>
                             <div class="whitespace-nowrap text-primary">24/5/2023</div>     
                            </td>
