...
<html lang="en" class="light">
    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        ...
        color: #1e40af;">Create Salesman</h2>
        ...
        <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                    ...
                    <input id="input-wizard-3" type="text" class="form-control" placeholder="ID">
                </div>
                <div class="intro-y col-span-12 sm:col-span-6">
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                    ...
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Mobile Number">
                </div>
                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">Address</label>
                    <textarea id="update-profile-form-5" class="form-control" placeholder="Address"></textarea>
                </div>

                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">Country</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Country">
                </div>
                <!--<div class="intro-y col-span-12 sm:col-span-6">-->
