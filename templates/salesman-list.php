    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            ...
            <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
                ...
                <a href="salesman-add.php"><button class="btn btn-primary shadow-md mr-2">Add New Salesman</button></a>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-60">
                                <a href="salesman-view.php" class="font-medium whitespace-nowrap">Ramshad Hassan</a>
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap"><span>145</span> / <span class="text-success">100</span> / <span class="text-danger">45</span></div>
                            </td>
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap"><span>130</span> / <span class="text-success">90</span> / <span class="text-danger">40</span></div>
                            </td>
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap"><span>120</span> / <span class="text-success">80</span> / <span class="text-danger">20</span></div>
                            </td>
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap"><span>Total Proposal: 350,000.00</span></div>
                                <div class="flex items-center justify-center whitespace-nowrap"><span class="text-success">Success: 200,000.00</span></div>
                                <div class="flex items-center justify-center whitespace-nowrap"><span class="text-danger">Failed: 50,000.00</span></div>
                                <div class="flex items-center justify-center whitespace-nowrap"><span class="text-primary">Pending: 100,000.00</span></div>
                            </td>
                            
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    <a title="Reset Password" class="flex items-center text-primary whitespace-nowrap mr-5" href="salesman-password.php">
                                        <i data-lucide="key" class="w-4 h-4 mr-1"></i>
                                    </a>
                                    <a title="Edit" class="flex items-center text-primary whitespace-nowrap mr-5" href="salesman-edit.php">
                                        <i data-lucide="edit" class="w-4 h-4 mr-1"></i>
                                    </a>
                                     <a title="View" class="flex items-center text-primary whitespace-nowrap mr-5" href="salesman-view.php">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-20">
                                <a href="" class=" whitespace-nowrap">6</a>
                            </td>
                            <td class="w-60">
                                <a href="salesman-view.php" class="font-medium whitespace-nowrap">Ramshad Hassan</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">5534 6688</div>
