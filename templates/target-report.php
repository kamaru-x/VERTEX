            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">GIVEN TARGET</th>
                        <th class="text-center whitespace-nowrap">ACHIEVED TARGET</th>
                        <th class="whitespace-nowrap" style="
                            text-align: center;">PENDING TARGET</th>
                        <th class="whitespace-nowrap">
                            <div class="pr-16">PERCENTAGE OF ACHIEVEMENT</div>
                        </th>
                ...
                <tbody>
                        <tr class="intro-x">
                            ...
                            <td class="w-60">
                                <a href="" class="font-medium whitespace-nowrap">345,000</a>
                            ...
                            <td class="w-60 text-right text-danger">
                                <div class="pr-16">100,000</div>
                            </td>
                            <td>
                             <div class="whitespace-nowrap">70%</div>
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                             <div class="whitespace-nowrap w-60">70% </div>
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                             <div class="whitespace-nowrap">70% 
                             </div>
