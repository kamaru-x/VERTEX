...
<html lang="en" class="light">
    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        ...
        color: #1e40af;">Edit Pending Task</h2>
        ...
        <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                    ...
                    <input id="input-wizard-2" type="text" class="form-control" placeholder="ABCD International">
                </div>
                
                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">Reference</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="REF:12345">
                </div>
                 <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">Salesman</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Ramshad Hassan / #ID345">
                </div>

                 <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">Task Title</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Inventory Procurement">
                </div>

                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label"style="text-align: center;">Priority</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="Medium">
                </div>

                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-3" class="form-label">Due Date</label>
                    <input id="input-wizard-3" type="text" class="form-control" placeholder="2/10/2023">
                </div>
