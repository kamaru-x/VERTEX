                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a class="flex items-center text-primary whitespace-nowrap mr-5" href="task-staff-view.php">
