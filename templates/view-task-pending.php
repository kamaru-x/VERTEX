...
<html lang="en" class="light">
    ...
    <h2 class="intro-y text-lg font-medium mt-10" style="text-align: center;font-size: 35px;color:#1e40af;padding-top: 30px;padding-bottom: 30px;border-bottom: solid 1px #bcbcbc21;">Pending Task</h2>
                                    ...
                                    <div class="col-span-12 lg:col-span-8 p-8 border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-darkmode-300 border-dashed">
                                        ...
                                        <div class="tab-content px-5 pb-5">
                                            <div class="tab-pane active grid grid-cols-12 gap-y-8 gap-x-10" id="weekly-report" role="tabpanel" aria-labelledby="weekly-report-tab">
                                                ...
                                                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                                    <div class="text-slate-500 head">Company Name</div>
                                                    <div class="mt-1.5 flex items-center">
                                                        <div class="text-base">XYZ International<br>4433 6688 / info@abcdintl.com</div>
                                                    </div>
                                                </div>
                                                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                                    <div class="text-slate-500 head">Task Title</div>
                                                    <div class="mt-1.5 flex items-center">
                                                        <div class="text-base">Inventory Procurement</div>
                                                    </div>
                                                </div>
                                                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                                    <div class="text-slate-500 head">Due Date</div>
                                                    <div class="mt-1.5 flex items-center">
                                                        <div class="text-base">12/3/2023</div>
                                                        
                                                    </div>
                                                </div>
                                                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                                    <div class="text-slate-500 head">Priority</div>
                                                    <div class="mt-1.5 flex items-center">
                                                        <div class="text-base">Medium</div>
                                                    </div>
                                                </div>
                                                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                                    <div class="text-slate-500 head">Description</div>
                                                    <div class="mt-1.5 flex items-center">
                                                        <div class="text-base">Description Here
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="post intro-y overflow-hidden box mt-5">
                ...
                <div class="post__content tab-content">
                     <h2 style=" font-size: 30px; font-weight: 500; text-align: center; color: #1e40af; padding-top: 100px;">Message</h2>
                        ...
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                            ...
                            <div class="mt-5">
                                ...
                                <div>
                                    ...
                                    <label for="post-form-7" class="form-label" style="font-weight:600;">Name</label>
                                    <div>Reema</div><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Send Message </h2>
                </div>
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                     ...
                     <div class="col-span-12">
                        <label for="pos-form-2" class="form-label">Message</label>
                       <textarea id="update-profile-form-5" class="form-control" placeholder="Message"></textarea>
                    </div>
                </div>
                <div class="modal-footer text-right">
                    <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-32 mr-1">Cancel</button>
                    <button type="button" class="btn btn-primary w-32">Send</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="new-order-modal2" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Send Reply </h2>
                </div>
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                        <label for="pos-form-1" class="form-label">Date</label>
                ...
                <div class="modal-footer text-right">
                    <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-32 mr-1">Cancel</button>
                    <button type="button" class="btn btn-primary w-32">Send Reply</button>
                </div>
            </div>
        </div>
    </div>
